...
?>	
			<div class="bikeshed bikeshed_typography">
				<div class="select_wrapper font_size_select_wrapper">
					<select name="<?php echo $font_size_name?>" id="<?php echo $font_size_id?>" class="font_size_select" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>>
				...
				<div class="select_wrapper font_family_select_wrapper">
					<select name="<?php echo $font_family_name?>" id="<?php echo $font_family_id?>" class="font_family_select" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>>
				...
				<div class="select_wrapper font_style_select_wrapper">
					<select name="<?php echo $font_style_name?>" id="<?php echo $font_style_id?>" class="font_style_select" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>>
				...
				<div class="color_picker_wrapper">
					...
					<input type="text" name="<?php echo $font_color_name; ?>" id="<?php echo $font_color_id; ?>" class="wp-color-picker" value="<?php echo $values['font_color']; ?>" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?> />
					<?php else: ?>
					<input data-default-color="<?php echo $options['default_color']; ?>" type="text" name="<?php echo $font_color_name; ?>" id="<?php echo $font_color_id; ?>" class="wp-color-picker" value="<?php echo $values['font_color']; ?>" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?> />
					<?php endif; ?>
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php _e($options['description']);?></p>
